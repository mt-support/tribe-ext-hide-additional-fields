...
// admin-view of custom fields on events
// events-calendar-pro/src/admin-views/event-meta.php
		...
		<tr>
			...
			<td>
				...
				<?php elseif ( 'radio' === $customField['type'] ): ?>
					<div>
						<label><input type="radio" name="<?php echo esc_attr( $customField['name'] ) ?>" value="" <?php checked( trim( $val ), '' ) ?>/> <?php esc_html_e( 'None', 'tribe-events-calendar-pro' ); ?>
						</label>
					</div>
